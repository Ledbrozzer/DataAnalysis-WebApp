...
#MkSure-allColuns used t/t-merge be treated LIKEstrings
...
#Convert coluns t/N°,forcng erros t/NaN
...
#Convert colum'Data Req.'t/format datetime correctly
...
#Add coluns'PLACA/','Tipo','Modelo','Base't/DataFrame d'abastecimento
...
#Adjust-argumentsFRMfunç`.contains()`
...
#Mini tbl w/3abastecimentos w/ Km/Litro lowest t/each Veículo/Equip.
