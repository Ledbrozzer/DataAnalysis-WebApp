...
#MkSureAll coluns usedt/t-merge B treatd LKstrings
...
#Convrt coluns t/n°, forcng erros t/NaN
...
#Convrt colum'Data Req.'t/format datetimeCorrectly
...
#Add coluns'PLACA/','Tipo','Modelo','Base't/tDataFrame abastecimento
...
#Add filtr t/"Veículo/Equip.","PLACA/","Base","Tipo"
...
def analise8(filtro):
    fig = px.histogram(filtro, x='Base', y='Km por Litro', color='Base', hover_data=['Tipo', 'Base', 'Km Rodados'], title='Análise 8: Km/Litro por Base')
    return fig

def analise9(filtro):
    fig = px.histogram(filtro, x='Km por Litro', y='Base', color='Data Req.', hover_data=['Tipo', 'Data Req.', 'Km por Litro', 'Base'], title='Análise 9: Performance-Base/Data')
    return fig

def analise10(filtro):
    fig = px.histogram(filtro, x='Km por Litro', y='Tipo', color='Veículo/Equip.', hover_data=['Tipo', 'Data Req.', 'Km por Litro', 'Base', 'Veículo/Equip.'], title='Análise 10: Km/Litro por Tipo')
    return fig

def analise11(filtro):
    fig = px.histogram(filtro, x='Base', y='Vlr. Total', color='Tipo', hover_data=['Tipo', 'Vlr. Total', 'Km por Litro', 'Base', 'Veículo/Equip.'], title='Análise 11: Vlr Total por Base/Tipo')
    return fig
...
def analise13(filtro):
    fig = px.histogram(filtro, x='Data Req.', y='Km Rodados', color='Base', hover_data=['Tipo', 'Km Rodados', 'Base', 'Data Req.'], title='Análise 13: Performance Km/Base por Data')
    return fig
